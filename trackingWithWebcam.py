...
#from imutils.video import VideoStreamimport
#import numpy as np
...
if __name__ == "__main__":
	...
	ap = argparse.ArgumentParser(argument_default = '--cascade haarcascade_frontalface_default.xml') ; print(ap)
		#help="path to input Haar cascade for face detection")
	args = vars(ap.parse_args()); args = {'cascade' : 'haarcascade_frontalface_default.xml'} ; print(args)
